...
require.define("/test/test.js",function(require,module,exports,__dirname,__filename,process,global){var test = require("tape")
...
test("flush gets called", function (assert) {
    var enqueue = Queue(function (v, callback) {
        callback()
    })

    enqueue("one", function () {
        assert.ok(true)
        assert.end()
    })
})
...
require.define("timers",function(require,module,exports,__dirname,__filename,process,global){exports.setTimeout = setTimeout;
...
require.define("/index.js",function(require,module,exports,__dirname,__filename,process,global){module.exports = Queue
...
require.define("/examples/flush.js",function(require,module,exports,__dirname,__filename,process,global){var assert = require("assert")
var setTimeout = require("timers").setTimeout
...
require.define("/examples/simple.js",function(require,module,exports,__dirname,__filename,process,global){var assert = require("assert")
var setTimeout = require("timers").setTimeout
...
require.define("/test/index.js",function(require,module,exports,__dirname,__filename,process,global){require("./test")
